...
console.log("res : "+ (categoryListData === null));
console.log("Enter function");
// window.alert("final alert");
function categoryLists(){
    var categoryList = document.getElementById('category-list');    
    console.log("Cat list  "+(categoryList === null));
    ...
    categoryListData.map(item => {
        ...
        console.log("clone lisr "+ (cloneListCard === null));  
        console.log(document.querySelector('.category-header') === null);
...
console.log("Address");
console.log(document.getElementById('add-address') === null);
// window.alert("alert here");
function addAddress(){
   window.location.href = "address_html.html";
...
account.addEventListener('click',loadAccountPage);
function loadAccountPage(){
   window.location.href = "login_index.html";
}

let orderButton = document.getElementById('cart-btn');
orderButton.addEventListener('click',deliverMessage);

function deliverMessage(){
    let msg = "Your Order has been plcaed\nPayment mode : COD\n";
